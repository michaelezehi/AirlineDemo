           ...
           return new List<PassengerDetails>
            {
                ...
                new PassengerDetails { FirstName = "Suzy", Age = 21, PassengerType = PassengerType.Loyalty,  LoyaltyPoints = 40, IsUsingExtraBaggageAllowance = false, IsUsingLoyaltyPoint = true},
                new PassengerDetails { FirstName = "Jone", Age = 56, PassengerType = PassengerType.Loyalty, LoyaltyPoints = 100, IsUsingExtraBaggageAllowance = true, IsUsingLoyaltyPoint = false},
